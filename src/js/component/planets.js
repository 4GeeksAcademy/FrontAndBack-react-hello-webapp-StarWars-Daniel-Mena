...
export const Planet = (props) => {
	...
	return (
		<div className="card border-warning border-3">
			<img src={props.img} className="card-img-top" alt="Planet img" style={{height:"250px"}}/>
			<div className="card-body">
				...
				<div className="d-flex justify-content-between">
					...
					<i className={`fa fa-2x fa-heart mt-1 me-1 ${bgIcon==false ? "text-primary": "text-warning"}`} onMouseOver={iconOver} onMouseOut={iconOut} onClick={() => actions.addFavouritePlanet(props.id, props.name, url)}></i>
				</div>
